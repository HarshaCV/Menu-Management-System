...
public class MenuDataSwing {
  ...
  JPanel mainMenuSelectP, mainMenuViewP, addMenuSelectP, addMenuViewP, viewMenuViewP, deleteMenuSelectP,
      deleteMenuViewP, searchMenuSelectP, searchMenuSelectP2, searchMenuViewP, updateMenuSelectP, updateMenuViewP,
      sortMenuViewP;
  JTextArea mainMTextA, addMTextA, viewMTextA, deleteMTextA, searchMTextAForView, searchMTextAForResult,
      updateMTextAForView, updateMTextAForResult, sortMTextAForResult;
  ...
  String newNameUpdate, newQualityUpdate, splittUpdate, newPrizeUpdate, recordUpdate1, IDUpdate1, IDUpdate2nd,
      recordUpdate2, choice;
  ...
  MenuDataSwing() {
   ...
   mainMenuSelectP.setBounds(580,250,250,250); //50,250,600,200
   mainMenuSelectP.setBackground(Color.white);
   
   mainMenuViewP=new JPanel();
   mainMenuViewP.setBounds(360,500,600,30);//(30, 280, 200, 30);
   mainMenuViewP.setBackground(Color.white);
   //---
   //--Add Menu Panel
   addMenuSelectP=new JPanel();
   addMenuSelectP.setBounds(500,250,170,200);
   ...
   sortMenuViewP.setBackground(Color.white);
    ...
    {// add menu view
     ...
     // ---
      ...
      addQualityL = new JLabel("Qty: ");
      addQualityL.setPreferredSize(new Dimension(40, 20));
    ...
    {// view menu view
     // ---
      ...
      // ---
      // ----------------------------------------------------------------
      JScrollPane scrollView = new JScrollPane(viewMTextA, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    {// delete menu view
      ...
      JScrollPane scrollDelete = new JScrollPane(deleteMTextA, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
          JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
    ...
    {// Search menu view
      searchMTextAForView = new JTextArea(
          "Select search input:\n\n1 ---> Search by Name\n2 ---> Search by Price\n3 ---> Search by Quality");
      searchMTextAForView.setPreferredSize(new Dimension(170, 100));
      searchMTextAForView.setEditable(false);

      String selectSearcg[] = { "1", "2", "3" };
      searchMComboBox = new JComboBox(selectSearcg);
      searchMComboBox.setPreferredSize(new Dimension(80, 20));
      ...
      // ----------------------------------------------------------------
      searchPrizeL = new JLabel("Price: ");//z
      ...
      searchPrizeBtn = new JButton("Search by Price");
      ...
      searchQualityBtn = new JButton("Search by Quality");
      searchQualityBtn.setPreferredSize(new Dimension(140, 20));
      // ----------------------------------------------------------------
      ...
      // ---
      // ----------------------------------------------------------------
      JScrollPane scrollSearch = new JScrollPane(searchMTextAForResult, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
          JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
    ...
    {// Update menu view
     ...
     // ---
      ...
      updatePrizeL = new JLabel("New Price: ");
      ...
      updateQualityL = new JLabel("New Qty: ");
    ...
    {// Sort menu view
      ...
      JScrollPane scrollSort = new JScrollPane(sortMTextAForResult, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
          JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
      // ------------------------- Display ---------------------------------------
          ...
          if (mainMComboBox.getSelectedItem().toString().equals("1")) {
            ...
            try {
              ...
              while ((record = bR1.readLine()) != null) {
                ...
                DisplayView1[i] = "ID = " + IDView + " *** Name = " + nameView + " *** Price = " + PrizeView
                    + " *** Quality = " + SorNView + "\n";
            ...
            try {
              ...
              while ((recordDelView = bR1DelView.readLine()) != null) {
                ...
                DisplayDel1[iDel] = "ID = " + IDDelView + " *** Name = " + nameDelView + " *** Price = " + PrizeDelView
                    + " *** Quality = " + SorNDelView + "\n";
            ...
            try {
              ...
              while ((recordSort = bR1Sort.readLine()) != null) {
                ...
                DisplaySort1[iSort] = "ID = " + IDSort + " *** Name = " + nameSort + " *** Price = " + PrizeSort
                    + " *** Quality = " + SorNSort + "\n";
          ...
          try {
            if (deleteMTextFID.getText().length() != 0) {
              ...
              while ((record2 = bR1.readLine()) != null) {
                ...
                DisplayView1[i] = "ID = " + IDDelete + " *** Name = " + nameDelete + " *** Price = " + PrizeDelete
                    + " *** Quality = " + SorNDelete + "\n";
      ...
      addMBtn.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent ae) {
          ...
          try {
            ...
            if (addMTextFID.getText().length() != 0 && addMTextFName.getText().length() != 0
                && addMTextFPrize.getText().length() != 0
                && (!(addMComboBQuality.getSelectedItem().toString().equals(addQval)))) {
            ...
            if (searchMTextFName.getText().length() != 0) {
              ...
              while ((recordSearch1 = brSearch1.readLine()) != null) {
                ...
                if (recordSearch1.contains(nameSearchSel)) {
                  DisplaySearch1[i1] = "ID = " + stSearchView1.nextToken() + " *** Name = " + stSearchView1.nextToken()
                      + " *** Price = " + stSearchView1.nextToken() + " *** Quality = " + stSearchView1.nextToken()
                      + "\n";
            ...
            if (searchMTextFPrize.getText().length() != 0) {
              ...
              while ((recordSearch2 = brSearch2.readLine()) != null) {
                ...
                if (recordSearch2.contains(PrizeSearchSel)) {
                  DisplaySearch2[i2] = "ID = " + stSearchView2.nextToken() + " *** Name = " + stSearchView2.nextToken()
                      + " *** Price = " + stSearchView2.nextToken() + " *** Quality = " + stSearchView2.nextToken()
                      + "\n";
          ...
          try {
            ...
            while ((recordSearch3 = brSearch3.readLine()) != null) {
              ...
              if (recordSearch3.contains(SorNSearchSel)) {
                DisplaySearch3[i3] = "ID = " + stSearchView3.nextToken() + " *** Name = " + stSearchView3.nextToken()
                    + " *** Price = " + stSearchView3.nextToken() + " *** Quality = " + stSearchView3.nextToken()
                    + "\n";
